...
export const RACE_PRIORITY_DAY_CELL: Record<RacePriority, string> = {
  ...
  C: 'bg-emerald-500/[0.08] text-emerald-950 dark:bg-emerald-500/[0.12] dark:text-emerald-100',
}
...
export const RACE_PRIORITY_DAY_TODAY: Record<RacePriority, string> = {
  ...
  C: 'ring-1 ring-inset ring-emerald-500/30',
}
...
export const RACE_PRIORITY_MONTH_CELL: Record<RacePriority, string> = {
  ...
  C: 'border-emerald-500/45 bg-emerald-500/[0.12] ring-1 ring-inset ring-emerald-500/20',
}
...
export const RACE_PRIORITY_MONTH_TODAY: Record<RacePriority, string> = {
  ...
  C: 'border-emerald-500/70 bg-emerald-500/20',
}
...
export const RACE_PRIORITY_MONTH_SELECTED: Record<RacePriority, string> = {
  ...
  C: 'border-emerald-500 bg-emerald-500/[0.12]',
}
...
export const RACE_PRIORITY_MONTH_TODAY_TEXT: Record<RacePriority, string> = {
  ...
  C: 'text-emerald-800 dark:text-emerald-100',
}
...
export const RACE_PRIORITY_SECTION: Record<RacePriority, string> = {
  ...
  C: 'border-emerald-500/35 bg-emerald-500/[0.05]',
}
...
export const RACE_PRIORITY_BLOCK: Record<RacePriority, string> = {
  ...
  C: 'border-2 border-emerald-400/80 bg-emerald-50 dark:border-emerald-500/55 dark:bg-emerald-950/35',
}

export function racePlanItemClass(compact = false): string {
  return cn(
    'border border-emerald-500/45 bg-emerald-500/12 shadow-sm',
    'hover:border-emerald-500/65 hover:bg-emerald-500/18',
...
export function raceDayStripClass(isToday = false): string {
  if (isToday) {
    return 'bg-emerald-600 text-emerald-50 shadow-sm ring-2 ring-emerald-400/50'
  }
