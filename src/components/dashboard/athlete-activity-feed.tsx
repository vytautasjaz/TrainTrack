...
export function AthleteActivityFeed({ workouts }: AthleteActivityFeedProps) {
  ...
  return (
    <section className="tt-home-mobile-card min-w-0 space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3 px-4 md:px-0">
        <header className="min-w-0 flex-1">
          <button
            ...
            className={cn(
              'flex w-full items-center justify-between gap-2 text-left md:pointer-events-none',
              !mobileOpen &&
      ...
      <MobileAccordionBody expanded={mobileOpen} className="space-y-4">
        {filtered.length === 0 ? (
          ...
          <>
            {/* Mobile — list flush to card edges */}
